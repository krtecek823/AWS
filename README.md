...
<table>
  <tbody>
    ...
    <tr>
      <td><strong>이민경</strong><br/>Frontend Lead / UI/UX Design<br/>React Native Expo 기반 크로스플랫폼 프론트엔드 앱 전체 설계 및 개발, 시니어 맞춤형 가독성 UI/UX 구성, AWS API 연동, 보호자 종합 대시보드 및 두뇌 훈련 게임 4종 개발</td>
    </tr>
  </tbody>
</table>
