...
const inputPath = 'C:/Users/jhh88/.gemini/antigravity/brain/251e14ad-c38a-4cc4-bbb6-a6784b41f619/mic_studio_indigo_1786284891589.png';
...
fs.createReadStream(inputPath)
  ...
  .on('parsed', function () {
    ...
    cropped.pack().pipe(fs.createWriteStream(outputPath)).on('finish', () => {
      console.log('Successfully saved transparent studio mic PNG:', outputPath);
    });
  });
