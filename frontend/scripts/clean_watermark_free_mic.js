...
const inputPath = 'C:/Users/jhh88/.gemini/antigravity/brain/251e14ad-c38a-4cc4-bbb6-a6784b41f619/no_watermark_mic_1786285100987.png';
  ...
  .on('parsed', function () {
    ...
    for (let y = 0; y < this.height; y++) {
      for (let x = 0; x < this.width; x++) {
        ...
        // Pure white background threshold
    ...
    console.log(`Watermark-free mic crop bounds: [${minX}, ${minY}, ${maxX}, ${maxY}]`);
    ...
    cropped.pack().pipe(fs.createWriteStream(outputPath)).on('finish', () => {
      console.log('Successfully saved 100% watermark-free crystal clear studio mic PNG:', outputPath);
    });
  });
